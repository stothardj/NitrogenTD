(ns nitrogentd.game.statuseffect.fright
  (:use [nitrogentd.game.statuseffect.statuseffect :only [StatusEffect]]
        [nitrogentd.game.gamestate :only [time-passed?]])
  (:require [nitrogentd.game.statuseffect.statuseffect :as s]))
