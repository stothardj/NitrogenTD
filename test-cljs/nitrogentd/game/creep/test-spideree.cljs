(ns nitrogentd.game.creep.test-spideree
  (:require-macros [cemerick.cljs.test :refer (is deftest run-tests)])
  (:use [nitrogentd.game.animation.numberanimation :only [NumberAnimation]]
        [nitrogentd.game.statuseffect.slow :only [Slow]])
  (:require [cemerick.cljs.test :as t]
            [nitrogentd.game.creep.creep :as c]
            [nitrogentd.game.creep.spideree :as s]
